...
function CardUserTender({item}) {
  ...
  return (
    <div className="rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 md:min-w-[1000px] mb-4 text-sm">
      <div className="flex justify-between">
        <div className="md:min-w-[800px]">
          ...
          <div className="w-full mb-3 flex justify-start gap-3">
            {item.subcategories?.map((sub, index) => (
              <span key={index} className="inline-block whitespace-nowrap rounded-full bg-neutral-200 py-1 px-2   text-center align-baseline text-[0.70em] font-bold leading-none text-neutral-600">
                {sub.name}
              </span>
            ))}
          </div>
          ...
          <div className="flex gap-2">
            ...
            <button
              type="button"
              className="inline-block rounded bg-green-600 px-3 py-2 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#059669] transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-[0_8px_9px_-4px_rgba(5,150,105,0.3),0_4px_18px_0_rgba(5,150,105,0.2)] focus:bg-green-700 focus:shadow-[0_8px_9px_-4px_rgba(5,150,105,0.3),0_4px_18px_0_rgba(5,150,105,0.2)] focus:outline-none focus:ring-0 active:bg-green-800"
        ...
        <div className="w-full flex flex-col item-center gap-3">
          <span className="inline-block whitespace-nowrap rounded-[0.27rem] bg-info-100 px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-info-800 text-sky-700">
          ...
          <span className="inline-block whitespace-nowrap rounded-[0.27rem] bg-red-500 px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-info-200">
